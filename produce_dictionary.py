...
print(produce.loc[['Quantity Sold','Total Sale'], 'Apples':'Lettuce'],'\n')
...
print(produce.at['Quantity Sold', 'Apricots'])
print(produce.at['Total Sale', 'Apricots'],'\n')
